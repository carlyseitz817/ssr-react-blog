  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Auth, [{
    ...
    value: function serverAuth(req) {
      if (req.headers.cookie) {
        ...
        var verifiedToken = this.verifyToken(token); // const expiresAtCookie = req.headers.cookie.split(";").find(c => c.trim().startsWith("expiresAt="));
...
//# sourceMappingURL=callback.js.aebd1ded1948883e9495.hot-update.js.map