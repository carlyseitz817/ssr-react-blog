...
/******/ 			var chunk = require("../../../" + ({}[chunkId]||chunkId) + "." + {"a81d":"978bc012ed6f2399f86e"}[chunkId] + ".js");
...
module.exports = __webpack_require__("BK4c");
...
var utils = __webpack_require__("hw50");

// EXTERNAL MODULE: external "react-toastify"
var external_react_toastify_ = __webpack_require__("oAEb");

// EXTERNAL MODULE: ./components/SaveDraft.js
var SaveDraft = __webpack_require__("qExA");
...
// CONCATENATED MODULE: ./components/StatusButton.js
...
var StatusButton_StatusButton =
/*#__PURE__*/
function (_React$Component) {
  Object(inherits["a" /* default */])(StatusButton, _React$Component);

  function StatusButton(props) {
    Object(classCallCheck["a" /* default */])(this, StatusButton);

    return Object(possibleConstructorReturn["a" /* default */])(this, Object(getPrototypeOf["a" /* default */])(StatusButton).call(this, props));
  }

  Object(createClass["a" /* default */])(StatusButton, [{
    key: "displayButton",
    value: function displayButton(item) {
      return external_react_default.a.createElement(external_reactstrap_["Button"], Object(esm_extends["a" /* default */])({
        color: "secondary"
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement("div", null, this.displayButton(item));
    }
  }]);
...
// CONCATENATED MODULE: ./pages/postEditorUpdate.js
...
var CKEditor = dynamic_default()(function () {
  return __webpack_require__.e(/* import() */ "a81d").then(__webpack_require__.bind(null, "uWK0"));
}, {
  ssr: false,
  loadableGenerated: {
    webpack: function webpack() {
      return [/*require.resolve*/("uWK0")];
    },
...
var postEditorUpdate_PostEditorUpdate =
/*#__PURE__*/
function (_React$Component) {
  Object(inherits["a" /* default */])(PostEditorUpdate, _React$Component);

  Object(createClass["a" /* default */])(PostEditorUpdate, null, [{
    key: "getInitialProps",
    value: function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 3;
                _context.next = 6;
                return Object(actions["c" /* getPostById */])(postId);
  ...
  function PostEditorUpdate(props) {
    ...
    Object(classCallCheck["a" /* default */])(this, PostEditorUpdate);

    _this = Object(possibleConstructorReturn["a" /* default */])(this, Object(getPrototypeOf["a" /* default */])(PostEditorUpdate).call(this, props));

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handletitle", function (evt) {
      return _this.setState({
        title: evt.target.value
      });
    });

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleSubtitle", function (evt) {
      return _this.setState({
        subtitle: evt.target.value
      });
    });

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "statusOption", function (post) {
    ...
    _this.updatePost = _this.updatePost.bind(Object(assertThisInitialized["a" /* default */])(_this));
    return _this;
  }

  Object(createClass["a" /* default */])(PostEditorUpdate, [{
    key: "updatePost",
    value: function updatePost(story) {
      ...
      Object(actions["h" /* updatePost */])(updatedPost, post._id).then(function (updatedPost) {
        external_react_toastify_["toast"].success('Post Saved Succesfuly!'); // this.setState({isSaving: false});
      }).catch(function (err) {
        // this.setState({isSaving: false});
        var message = err.message || 'Server Error!';
        external_react_toastify_["toast"].error('Unexpected Error, Copy your progress and refresh browser please.');
    ...
    value: function changeStatus(status, postId) {
      ...
      Object(actions["h" /* updatePost */])({
        ...
        routes["Router"].pushRoute("/blog/".concat(postId, "/edit"));
        external_react_toastify_["toast"].success('Post status updated');
      }).catch(function (err) {
        external_react_toastify_["toast"].error('Unexpected Error, Copy your progress and refresh browser please.');
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(BaseLayout["a" /* default */], this.props.auth, external_react_default.a.createElement(BasePage["a" /* default */], {
        containerClass: "editor-wrapper",
        className: "blog-editor-page"
      }, external_react_default.a.createElement("label", null, "Title"), external_react_default.a.createElement("input", {
        value: this.state.title,
        className: "titlez",
        onChange: this.handletitle
      }), external_react_default.a.createElement("br", null), external_react_default.a.createElement("label", null, "Subtitle"), external_react_default.a.createElement("input", {
        value: this.state.subtitle,
        className: "subtitlez",
        onChange: this.handleSubtitle
      }), external_react_default.a.createElement("br", null), external_react_default.a.createElement("br", null), external_react_default.a.createElement(CKEditor, {
        className: "blogtext",
        config: {
          extraPlugins: [utils["b" /* imagePluginFactory */]]
        },
        data: post.story,
        save: this.saveBlog,
      ...
      }), external_react_default.a.createElement("br", null), external_react_default.a.createElement(StatusButton_StatusButton, {
        item: this.statusOption(post)
      }), external_react_default.a.createElement(SaveDraft["a" /* default */], {
...
/* harmony default export */ var postEditorUpdate = __webpack_exports__["default"] = (Object(withAuth["a" /* default */])(postEditorUpdate_PostEditorUpdate));
...
function SaveDraft(props) {
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("button", Object(_babel_runtime_corejs2_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])({}, props, {
    style: {
      float: "right",
      marginBottom: 10
    },
...
/* harmony default export */ __webpack_exports__["a"] = (SaveDraft);
